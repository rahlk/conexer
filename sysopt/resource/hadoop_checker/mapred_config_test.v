...
Definition a_mapred_config: MapRedConfig.
    ...
    (mapreduce_map_java_opts.mk false (mk_java_opts 819%positive 100%positive) _ )
    ...
    (mapreduce_reduce_java_opts.mk false (mk_java_opts 1640%positive 100%positive) _ )
    (mapreduce_reduce_markreset_buffer_percent.mk false (0/100)%R _ )
    (mapreduce_reduce_memory_mb.mk false 2048%positive _ )
